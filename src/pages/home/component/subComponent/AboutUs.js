    ...
    render() {
        return (
            <div className="about-us pt-5 pb-5 pt-sm-0 pb-sm-0">
                ...
                <div className="line--img mb-4 mt-4"><img className="img-fluid" src={imgLine} alt="line" /></div><img className="float-left" src={imgLogo} alt="logo" />
                ...
                <p className="body--content">
                    ...
                    cái Blog này vào một ngày đầu hè nóng oi bức, khi mà dân tình xô nhau đi tắm
                    Free để giải nhiệt.
                </p><a className="link--content" href="#">Xem thêm</a>
            </div>
        );
    }
}
